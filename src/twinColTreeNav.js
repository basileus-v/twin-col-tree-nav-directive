...
angular.module('twinColTreeNav',[])
  .directive('twinColTreeNav', function () {
    return {
      templateUrl: 'template/twinColTreeNav.html',
      restrict: 'EA',
      scope: {
        treeData: '='
      },
  ...
  angular.module("template/twinColTreeNav.html", []).run(["$templateCache", function($templateCache) {
    $templateCache.put("template/twinColTreeNav.html",
